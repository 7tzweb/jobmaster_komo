...
--
-- Table structure for table `users_c`
--
...
CREATE TABLE `users_c` (
  ...
  `crole` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- AUTO_INCREMENT for table `users_c`
--
ALTER TABLE `users_c`
